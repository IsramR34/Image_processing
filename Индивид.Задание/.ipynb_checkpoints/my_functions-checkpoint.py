...
# Исправленные импорты для TensorFlow 2.x / Keras >= 2.9
from tensorflow.keras.utils import Sequence  # замена Iterator
...
class RotNetDataGenerator(Sequence):
    ...
    def __getitem__(self, index):
        index_array = self.indices[index * self.batch_size:(index + 1) * self.batch_size]
